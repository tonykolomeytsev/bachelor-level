...
\renewcommand{\cftsubsecfont}{\hspace{32pt}} % убрал отступ подпараграфов в расписании
...
\newcommand{\fixme}{\color{red} \textbf{FIXME} \color{black}}
\usepackage{pdfpages}
...
% \includechapter{body_orientation} % на удаление

\includechapter{walking_model} % вернуть после ревью
...
\newpage
\addcontentsline{toc}{likechapter}{ПРИЛОЖЕНИЕ А: ПОСТРОЕНИЕ РАБОЧЕЙ ОБЛАСТИ}
\includepdf[pages={1,2}]{append1.pdf}
